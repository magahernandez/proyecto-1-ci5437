...
PSVNOPT = --state_map --no_backwards_moves --fwd_history_len=2
...
.PHONY: clean
clean:
	rm -fr *.succ *.dist *.distSummary *.c *.dist_pdb *.aStar *.idaStar *.bfs *.hpp psvn2c_core.c psvn2c_state_map.c psvn2c_abstraction.c abstractor *.dSYM *.o *~
